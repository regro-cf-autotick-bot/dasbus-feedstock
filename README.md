...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dasbus-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14300&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dasbus-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dasbus` can be installed with:

```
conda install dasbus
```

It is possible to list all of the versions of `dasbus` available on your platform with:
